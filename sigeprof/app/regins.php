...
if (isset($_POST['btn-reg'])) {
    $insert = $conn->prepare('INSERT INTO instructor(dni, nombre, apellido, edad, correo, nombre_de_usuario, contraseña, rol) VALUES(?,?,?,?,?,?,?,?)');
...
<body class="bg-reg">
    ...
    <main class="form-signin m-auto pt-5 mt-4 col-md-4">
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="../assets/img/logo.png" alt="Logo" width="251" height="125">
                    <h1 class="display-6">Registro Administrador</h1>
                </div>
                <form action="" method="post" enctype="application/x-www-form-urlencoded">
                    ...
                    <div>
                        ...
                        <select class="form-select" name="tipo_documento" id="tipo_documento" type="number">
                    ...
                    <div>
                        ...
                        <input type="number" name="edad" id="edad" placeholder="Ingrese su edad" class="form-control"
                            required>
                    </div><br>
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre_de_usuario" id="nombre_de_usuario"
                            placeholder="Ingrese su nombre de usuario" class="form-control" required>
                    </div><br>
