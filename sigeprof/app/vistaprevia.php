...
<body class="h-100">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item"><a class="nav-link" href="./reg_user">Registrarse</a></li>
        </ul>
        <div class="d-flex">
  ...
  <main class="container pt-5 mt-5">
    <section class="section-card py-5">
      ...
      <h3 class="section-title text-center" style="font-size: 18px;">(Desactualizado, para ver los proyectos actualizados, inicia sesion o registrate)</h3>
