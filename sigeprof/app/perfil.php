...
if (isset($_POST['btn-update'])) {
    $updperfil = $conn->prepare("UPDATE instructor SET nombre = ?, apellido = ?, correo = ?, borndate = ?, picture = ?, aboutme = ? WHERE id = ?");
    ...
    if ($updperfil->execute()) {
        $msg = array("Perfil actualizado", "success");
    } else {
        $msg = array("Perfil no actualizado", "danger");
    }
...
<section class="pt-2 pt-5 pb-5 mt-4">
                ...
                <div class="card mb-3" style="border-radius: .5rem;">
                    <div class="row g-0">
                        <div class="col-md-4 gradient-custom text-center"
                            ...
                            <img src="<?php echo $data['picture']; ?>" alt="picture" class="img-fluid my-5"
                                style="width: 150px;" />
                            <h5>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="row pt-1">
                                    <div class="col-12 mb-3">
                                        <p class="text-muted">
                                            <?php echo $data['aboutme']; ?>
                                        </p>
                                    </div>
                                </div>
                                <div class="d-grid">
                                    <button type="button" class="btn btn-primary btn-block" name="btn-update"
                                        data-bs-toggle="modal" data-bs-target="#profileupdate">
                                        Editar
                                    </button>
                                </div>
                            </div>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" class="form-control" id="fname" placeholder="Ingrese sus nombres"
                                name="fname" value="<?php echo $data['nombre']; ?>" required>
                        </div>
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" class="form-control" id="lname" placeholder="Ingrese sus apellidos"
                                name="lname" value="<?php echo $data['apellido']; ?>" required>
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="email" class="form-label">Correo:</label>
                            <input type="email" class="form-control" id="email" placeholder="Ingrese su email"
                                name="email" value="<?php echo $data['correo']; ?>" required>
                        </div>
                        <div class="mb-3 mt-3">
                            ...
                            <input type="date" class="form-control" id="borndate" name="borndate"
                                value="<?php echo $data['borndate']; ?>" required>
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="picture" class="form-label">Imagen de perfíl:</label>
                            <input type="file" class="form-control" value="<?php echo $data['picture']; ?>" id="picture" name="picture">
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="aboutme" class="form-label">Sobre mí:</label>
                            <textarea class="form-control" name="aboutme"
                                id="aboutme"><?php echo $data['aboutme']; ?></textarea>
                        </div>
